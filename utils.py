...
def draw_rounded_rect(renderer, point1, point2, color, width, radius):
    draw_line(renderer, point1, point2, color, (width - (2*radius)))

    if point1[0] > point2[0]:
        side1_point1 = (point1[0]+radius, point1[1])
        side1_point2 = (point2[0]+radius, point2[1])
        side2_point1 = (point1[0]-radius, point1[1])
        side2_point2 = (point2[0]-radius, point2[1])
    else:
        side1_point1 = (point1[0]-radius, point1[1])
        side1_point2 = (point2[0]-radius, point2[1])
        side2_point1 = (point1[0]+radius, point1[1])
    ...
    draw_rounded_line(renderer, side1_point1, side1_point2, color, radius)
    draw_rounded_line(renderer, side2_point1, side2_point2, color, radius)
...
def draw_circle(renderer, x, y, color, radius):
    # Define a circle using triangles (triangle fan)
    #segments = max(16, int(radius))  # Adjust number of segments based on radius
    segments = 16
